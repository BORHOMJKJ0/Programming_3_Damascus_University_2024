...
public class movie36 extends JFrame implements ActionListener {
    ...
    private int option,j;
    private Font font;
    private Cinema cinema1, cinema2, cinema3;
    private User user,User;
    private ArrayList<User>registerUsers1;

    public movie36(Cinema cinema1, Cinema cinema2, Cinema cinema3, User user) {
        loadChairStatusListFromFile("chairStatus36.txt");
        ...
        price = String.valueOf(movie36.this.cinema3.getMovies().get(11).getShowTime().getTicketsOfShow().get(0).getPrice());
        ...
        price = String.valueOf(movie36.this.cinema3.getMovies().get(11).getShowTime().getTicketsOfShow().get(1).getPrice());
        ...
        price = String.valueOf(movie36.this.cinema3.getMovies().get(11).getShowTime().getTicketsOfShow().get(2).getPrice());
        ...
        price = String.valueOf(movie36.this.cinema3.getMovies().get(11).getShowTime().getTicketsOfShow().get(3).getPrice());
        ...
        price = String.valueOf(movie36.this.cinema3.getMovies().get(11).getShowTime().getTicketsOfShow().get(4).getPrice());
        ...
        price = String.valueOf(movie36.this.cinema3.getMovies().get(11).getShowTime().getTicketsOfShow().get(5).getPrice());
        ...
        price = String.valueOf(movie36.this.cinema3.getMovies().get(11).getShowTime().getTicketsOfShow().get(6).getPrice());
        ...
        price = String.valueOf(movie36.this.cinema3.getMovies().get(11).getShowTime().getTicketsOfShow().get(7).getPrice());
        ...
        price = String.valueOf(movie36.this.cinema3.getMovies().get(11).getShowTime().getTicketsOfShow().get(8).getPrice());
        ...
        price = String.valueOf(movie36.this.cinema3.getMovies().get(11).getShowTime().getTicketsOfShow().get(9).getPrice());
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == homeButton) {
            ...
            this.dispose();
            saveChairStatusListToFile("chairStatus36.txt");
            ...
            reserveChair(chair1,cinema3.getMovies().get(11).getShowTime().getTicketsOfShow().get(0).getPrice(),1);
        } else if (e.getSource() == chair2) {
            reserveChair(chair2,cinema3.getMovies().get(11).getShowTime().getTicketsOfShow().get(1).getPrice(),2);
        } else if (e.getSource() == chair3) {
            reserveChair(chair3,cinema3.getMovies().get(11).getShowTime().getTicketsOfShow().get(2).getPrice(),3);
        } else if (e.getSource() == chair4) {
            reserveChair(chair4,cinema3.getMovies().get(11).getShowTime().getTicketsOfShow().get(3).getPrice(),4);
        } else if (e.getSource() == chair5) {
            reserveChair(chair5,cinema3.getMovies().get(11).getShowTime().getTicketsOfShow().get(4).getPrice(),5);
        } else if (e.getSource() == chair6) {
            reserveChair(chair6,cinema3.getMovies().get(11).getShowTime().getTicketsOfShow().get(5).getPrice(),6);
        } else if (e.getSource() == chair7) {
            reserveChair(chair7,cinema3.getMovies().get(11).getShowTime().getTicketsOfShow().get(6).getPrice(),7);
        } else if (e.getSource() == chair8) {
            reserveChair(chair8,cinema3.getMovies().get(11).getShowTime().getTicketsOfShow().get(7).getPrice(),8);
        } else if (e.getSource() == chair9) {
            reserveChair(chair9,cinema3.getMovies().get(11).getShowTime().getTicketsOfShow().get(8).getPrice(),9);
        } else if (e.getSource() == chair10) {
            reserveChair(chair10,cinema3.getMovies().get(11).getShowTime().getTicketsOfShow().get(9).getPrice(),10);
        }
    }
    ...
    private void reserveChair(JButton chair, int chairPrice, int num) {
        if(chair.getIcon() != null && chair.getIcon().toString().equals("JAVA/Chairs3.png")) {
            ...
            {
                if(num+350==user.getBookedTickets().get(i).getN_chair() && user.getBookedTickets().get(i).getShowTime()==3)
                {
                    j=1;
                    ...
                    if (option == JOptionPane.YES_OPTION) {
                        ...
                        Ticketing.cancelTicketing(user,cinema3.getMovies().get(11).getShowTime().getTicketsOfShow().get(num-1));
            ...
            if (user.getFunds() < chairPrice) {
                ...
                if (option == JOptionPane.YES_OPTION) {
                    ...
                    Ticketing.ticketing(user,cinema3.getMovies().get(11).getShowTime().getTicketsOfShow().get(num-1));
